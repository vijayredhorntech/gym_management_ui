    ...
    <section class="h-full w-full overflow-y-auto lg:pl-72 md:pl-72 pl-0 py-2 bg-lightTheme">
        <div class="lg:px-6 md:px-6 sm:px-4 px-2 mt-20">
            <div class="bg-whiteColor py-4 px-2 rounded-lg flex justify-between">
                ...
                <a href="{{route('exercise.create')}}" class="bg-darkText text-whiteColor font-semibold border-[1px] border-darkText px-6 py-1 rounded-md hover:bg-whiteColor hover:text-darkText transition ease-in duration-2000">Add New</a>
        ...
        <div class="lg:px-6 md:px-6 sm:px-4 px-2 grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1  gap-[20px] mt-4">
            ...
            <x-admin.exercise-card
              ...
              images="{{$exercise->media ? asset('storage/'. $exercise->media) : $exercise->link}}"
              id="{{$exercise->id}}"
            />
            @endforeach
{{--            <x-admin.exercise-card--}}
